...
let turnLEDoffP = "turn LED off", "CRYCYMCRWKWRKWYBRBKWKWRMKCYKMRYKWKWKWKWKWKYMGKWKWBGYKWKWKYWCKMYCM"
dasm turnLEDoffP
let turnLEDoffU = "turn LED off", "CRYCYMCRWKWRKWYBRYKWKWRCBKYKCYKMRYKWKWKWKWKWKYMGKWKWBGYKWKWKYWCRCBCM"
dasm turnLEDoffU
...
// CRY CYM CRW 
// 130 140 12E 01 03 CF 00 0C    2D 24 93 00 00 00 B8 00 1E 93 00 AE 26 14E
// 130 140 12E 01 03 CE 00 0D C7 2D 24 93 00 00 00 B8 00 1E 93 00 AE 5F 14E

let wait100x10msP = "wait 100 x 10ms", "CRYCYMCRWKWRKWYBGWKWKWRKWCYKMRYKWGKGYRWKWKYWCGCBCM"
// dasm wait100x10msP
let wait100x10msU = "wait 100 x 10ms", "CRYCYMCRWKWRKWYBGRKWKWRWBKYKCYKMRYKWGKGYRWKWKYWCBKMCM"
// dasm wait100x10msU

// CRY CYM CRW KWR KWY LEN ??? LEN PAY ??? ??? ??? 100 WAT ??? ??? CRC TRM
// 304 320 302 001 003 212 000 007     045 036 147 100 155 000 174 144 334
// 304 320 302 001 003 211 000 008 199 045 036 147 100 155 000 174 201 334
