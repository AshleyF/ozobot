...
// 00 AE
// dasm ("terminate program and turn Ozobot off", "CRYCYMCRWKWRKWYBGWKWKWRKWCYKMRYKWKWKYWCKWKYWCBWRCM")
// 00 AE 00 AE
...
// dasm ("set wheel speeds: left (mm/s) (30) right (mm/s) (40)", "CRYCYMCRWKWRKWYBGKWKWKRGBKYKCYKMRYKWKBGKMWYRMKWKYWCBWYCM")
// C7 2D 24 93 1E 28 9F 00 AE E3 14E (1E 28 9F)
// dasm ("set wheel speeds: left (mm/s) (-30) right (mm/s) (40)", "CRYCYMCRWKWRKWYBRCKWKWRYBKYKCYKMRYKWKBGKMBGBMYRMKWKYWCRCWCM")
// C7 2D 24 93 1E 27 83 9F 00 AE 61 14E (1E 27 83 9F) - 83 must be 'neg'

let turnLEDoffP = "turn LED off (paid)", "CRYCYMCRWKWRKWYBRBKWKWRMKCYKMRYKWKWKWKWKWKYMGKWKWBGYKWKWKYWCKMYCM"
// dasm turnLEDoffP
let turnLEDoffU = "turn LED off (paid)", "CRYCYMCRWKWRKWYBRYKWKWRCBKYKCYKMRYKWKWKWKWKWKYMGKWKWBGYKWKWKYWCRCBCM"
// dasm turnLEDoffU
...
//      CRY CYM CRW 
// P 130 140 12E 01 03 CF 00 0C    2D 24 93 00 00 00 B8 00 1E 93 00 AE 26 14E
// Not  130 140 12E 01 03 CE 00 0D C7 2D 24 93 00 00 00 B8 00 1E 93 00 AE 5F 14E

let wait100x10msP = "wait 100 x 10ms (paid)", "CRYCYMCRWKWRKWYBGWKWKWRKWCYKMRYKWGKGYRWKWKYWCGCBCM"
// dasm wait100x10msP
let wait100x10msU = "wait 100 x 10ms (paid)", "CRYCYMCRWKWRKWYBGRKWKWRWBKYKCYKMRYKWGKGYRWKWKYWCBKMCM"
// dasm wait100x10msU

//      CRY CYM CRW KWR KWY LEN ??? LEN PAY ??? ??? ??? 100 WAT ??? ??? CRC TRM
// P 304 320 302 001 003 212 000 007     045 036 147 100 155 000 174 144 334
